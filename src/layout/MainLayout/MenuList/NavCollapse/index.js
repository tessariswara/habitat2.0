          ...
          <ListItemButton
            sx={{
              ...
              ...(drawerOpen &&
                level === 1 &&
                mode !== ThemeMode.DARK && {
                  '&:hover': { bgcolor: 'habitat.primary', color: 'habitat.white' },
                  '&.Mui-selected': {
                    bgcolor: 'habitat.primary',
                    color: 'habitat.white',
                    '&:hover': { color: iconSelectedColor, bgcolor: '.habitat.primary' }
                  }
                }),
              ...((!drawerOpen || level !== 1) && {
                py: level === 1 ? 0 : 1,
                ...
                <List
                  ...
                  sx={{
                    ...
                    '&:after': {
                      ...
                      bgcolor: mode === ThemeMode.DARK ? 'dark.light' : 'habitat.primary'
                    }
                  }}
                >
                  {menus}
