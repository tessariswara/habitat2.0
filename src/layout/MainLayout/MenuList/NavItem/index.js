...
const NavItem = ({ item, level, isParents = false, setSelectedID }) => {
  ...
  const iconSelectedColor = mode === ThemeMode.DARK && drawerOpen ? 'habitat.white' : 'habitat.white';
          ...
          <ButtonBase aria-label="theme-icon" sx={{ borderRadius: `${borderRadius}px` }} disableRipple={drawerOpen}>
            <ListItemIcon
              sx={{
                ...
                color: isSelected ? iconSelectedColor : 'habitat.black',
                ...(!drawerOpen &&
                  level === 1 && {
                    borderRadius: `${borderRadius}px`,
                    width: 46,
                    ...
                    '&:hover': {
                      bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.secondary.main, 0.25) : 'habitat.primary',
                      color: 'habitat.white'
                    },
                    ...(isSelected && {
                      bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.secondary.main, 0.25) : 'habitat.primary',
                      color: 'habitat.white',
                      '&:hover': {
                        bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.secondary.main, 0.3) : 'habitat.primary',
                        color: 'habitat.white'
                      }
                    })
                  })
