...
const Palette = (mode, presetColor) => {
  ...
  return createTheme({
    palette: {
      ...
      habitat: {
        primary: mode === ThemeMode.DARK ? colors.darkPrimaryLight : colors.habitatPrimary,
        white: mode === ThemeMode.DARK ? colors.darkPrimaryMain : colors.habitatWhite,
        black: mode === ThemeMode.DARK ? colors.darkPrimaryDark : colors.habitatBlack,
        background: mode === ThemeMode.DARK ? colors.darkPrimary800 : colors.habitatBackground,
        200: mode === ThemeMode.DARK ? colors.darkPrimary200 : colors.habitat200
      },
      primary: {
